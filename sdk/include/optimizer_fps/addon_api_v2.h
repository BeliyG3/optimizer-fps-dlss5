...
using ConsumerCallbackV2 = void (OFPS_CALL *)(const PackedFrameV2 *frame, void *userData);
...
using RegisterConsumerFnV2 = Status (OFPS_CALL *)(const ConsumerRegistrationV2 *, std::uint64_t *);
using SubmitInputFnV2 = Status (OFPS_CALL *)(const FrameInputV2 *);
using PublishPackedFrameFnV2 = Status (OFPS_CALL *)(const PackedFrameV2 *);
...
OFPS_ADDON_EXPORT const ofps::sdk::AddonApiV2 *OFPS_CALL PeripheralWarpGetApiV2(

...
struct alignas(16) ShaderConstantsV3 {
    ...
    float bandCenterX;        // OfpsBandCenter: band centre (native px) X/Y, work centre (work px) X/Y
    float bandCenterY;
    float workCenterX;
    float workCenterY;
    float halfSpanNegX;       // OfpsSideNeg: half-span X/Y, centre fraction X/Y (negative side)
    float halfSpanNegY;
    float sideCenterNegX;
    float sideCenterNegY;
    float halfSpanPosX;       // OfpsSidePos
    float halfSpanPosY;
    float sideCenterPosX;
    float sideCenterPosY;
    float sideWorkNegX;       // OfpsSideWorkNeg: work fraction X/Y, compression X/Y (negative side)
    float sideWorkNegY;
    float sideCompressionNegX;
    float sideCompressionNegY;
    float sideWorkPosX;       // OfpsSideWorkPos
    float sideWorkPosY;
    float sideCompressionPosX;
    float sideCompressionPosY;
    float sideEdgeSlopeNegX;  // OfpsSideEdgeSlope: negative X/Y, positive X/Y
    float sideEdgeSlopeNegY;
    float sideEdgeSlopePosX;
    float sideEdgeSlopePosY;
    float workScaleX;         // OfpsWorkScale: work px per native-scaled px X/Y, centre offset X/Y
    float workScaleY;
    float centerOffsetX;
    float centerOffsetY;
};

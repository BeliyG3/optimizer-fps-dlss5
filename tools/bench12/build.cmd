...
cl /nologo /std:c++20 /EHsc /O2 /W4 /WX /permissive- /DWIN32_LEAN_AND_MEAN /DNOMINMAX /D_CRT_SECURE_NO_WARNINGS /Iexternal\imgui /Foobj\ /Fdobj\pw_bench12.pdb /Fepw_bench12.exe main.cpp animation.cpp animation_pose.cpp scene_animation.cpp menu_animation.cpp application.cpp menu.cpp menu_render.cpp flight.cpp settings.cpp json.cpp lamps.cpp scene_lamps.cpp device_resize.cpp pathtrace_resources.cpp pipeline.cpp display.cpp device_texture.cpp image_mips.cpp device.cpp device_dump.cpp device_timing.cpp image.cpp scene.cpp accel.cpp pathtrace.cpp pathtrace_pipeline.cpp ngx.cpp ngx_evaluate.cpp obj\imgui.obj obj\imgui_draw.obj obj\imgui_tables.obj obj\imgui_widgets.obj obj\imgui_impl_win32.obj obj\imgui_impl_dx12.obj /link d3dcompiler.lib dwmapi.lib d3d12.lib dxgi.lib dxguid.lib windowscodecs.lib ole32.lib user32.lib || goto :fail
cl /nologo /std:c++20 /EHsc /O2 /W4 /WX /permissive- /DWIN32_LEAN_AND_MEAN /DNOMINMAX /D_CRT_SECURE_NO_WARNINGS /Foobj\ /Fdobj\tests.pdb /Feobj\bench12_tests.exe tests.cpp tests_animation_perf.cpp tests_animation.cpp animation.cpp animation_pose.cpp tests_materials.cpp tests_interactive.cpp settings.cpp json.cpp lamps.cpp image_mips.cpp image.cpp /link windowscodecs.lib ole32.lib user32.lib || goto :fail
obj\bench12_tests.exe || goto :fail
echo [info] built pw_bench12.exe and shaders
popd
exit /b 0
:fail
popd
